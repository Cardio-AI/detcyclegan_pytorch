...
class TranslationTrainer:
    def __init__(self, options=None):
        ...
        #self.optimizer_G_A = torch.optim.Adam(self.netG_A2B.parameters(), lr=self.opt.lr, betas=(0.5, 0.999))
        #self.optimizer_G_B = torch.optim.Adam(self.netG_B2A.parameters(), lr=self.opt.lr, betas=(0.5, 0.999))
        ...
        #self.optimizers = [self.optimizer_G_A, self.optimizer_G_B, self.optimizer_D_A, self.optimizer_D_B]
    ...
    def run_epoch(self, epoch):
        ...
        for i, batch in enumerate(Bar(self.train_dataloader), 0):
            ...
            # Get data
            real_A, _, real_B, _ = batch  # omit masks for now
